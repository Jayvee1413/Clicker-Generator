...
Pushing to `main` automatically deploys to Google Cloud Run via `.github/workflows/deploy-gcp.yml`.
...
1. Open the [GitHub page](https://github.com/Jayvee1413/Clicker-Generator).
...
```bash
git clone https://github.com/Jayvee1413/Clicker-Generator.git
```
